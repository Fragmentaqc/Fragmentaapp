...
drop policy if exists "Les abonnements sont visibles par tous" on public.profile_follows;
drop policy if exists "Un membre peut suivre un profil" on public.profile_follows;
drop policy if exists "Un membre peut se désabonner" on public.profile_follows;
