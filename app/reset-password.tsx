...
const styles = StyleSheet.create({ safe: { flex: 1, backgroundColor: '#071310' }, container: { flex: 1, padding: 22, justifyContent: 'center' }, center: { flex: 1, padding: 24, alignItems: 'center', justifyContent: 'center' }, eyebrow: { color: '#62E6B1', fontSize: 10, fontWeight: '900', letterSpacing: 1.2 }, title: { color: '#F3FFF9', fontSize: 28, fontWeight: '900', textAlign: 'center', marginBottom: 20 }, description: { color: '#8FA69B', textAlign: 'center', lineHeight: 20 }, label: { color: '#DFFFF2', fontSize: 13, fontWeight: '900', marginTop: 14, marginBottom: 8 }, input: { minHeight: 56, borderRadius: 0, borderWidth: 1, borderColor: '#1D4538', backgroundColor: '#0C1C17', color: '#F3FFF9', paddingHorizontal: 16 }, button: { minHeight: 58, alignItems: 'center', justifyContent: 'center', borderRadius: 0, backgroundColor: '#62E6B1', marginTop: 24 }, buttonText: { color: '#071310', fontSize: 14, fontWeight: '900' }, secondary: { borderRadius: 0, borderWidth: 1, borderColor: '#28634F', padding: 14, marginTop: 20 }, secondaryText: { color: '#62E6B1', fontWeight: '900' }, disabled: { opacity: 0.5 } });
