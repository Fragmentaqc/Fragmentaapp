...
const styles = StyleSheet.create({
  ...
  label: { color: '#DFFFF2', fontSize: 13, fontWeight: '800', marginTop: 16, marginBottom: 8 }, input: { minHeight: 54, borderRadius: 0, borderWidth: 1, borderColor: '#1D4538', backgroundColor: '#0C1C17', color: '#F3FFF9', paddingHorizontal: 15, paddingVertical: 13 }, textarea: { minHeight: 140 }, chip: { borderRadius: 0, backgroundColor: '#10251E', paddingHorizontal: 14, paddingVertical: 10, marginRight: 8 }, active: { backgroundColor: '#28634F' }, chipText: { color: '#DFFFF2', fontSize: 12, fontWeight: '800' }, row: { flexDirection: 'row', gap: 9 }, option: { flex: 1, alignItems: 'center', borderRadius: 0, borderWidth: 1, borderColor: '#285345', padding: 14 }, note: { color: '#81958C', fontSize: 12, marginTop: 20 }, saveButton: { minHeight: 56, alignItems: 'center', justifyContent: 'center', borderRadius: 0, backgroundColor: '#62E6B1', paddingHorizontal: 20, marginTop: 24 }, saveText: { color: '#071310', fontSize: 14, fontWeight: '900' },
});
