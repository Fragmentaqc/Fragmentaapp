...
const styles = StyleSheet.create({
  ...
  searchBox: { height: 56, flexDirection: 'row', alignItems: 'center', borderWidth: 1, borderColor: '#28634F', borderRadius: 0, backgroundColor: '#0C1C17', paddingHorizontal: 14 }, searchIcon: { color: '#62E6B1', fontSize: 26, marginRight: 9 }, input: { flex: 1, color: '#F3FFF9', fontSize: 15 }, countryInput: { height: 48, color: '#F3FFF9', borderWidth: 1, borderColor: '#19392E', borderRadius: 0, backgroundColor: '#0C1C17', paddingHorizontal: 15, marginTop: 10 },
  chips: { gap: 8, paddingVertical: 14 }, chip: { borderWidth: 1, borderColor: '#1D4538', borderRadius: 0, paddingHorizontal: 14, paddingVertical: 9 }, chipActive: { backgroundColor: '#62E6B1', borderColor: '#62E6B1' }, chipText: { color: '#9EB0A8', fontSize: 12, fontWeight: '800' }, chipTextActive: { color: '#071310' }, resultLabel: { color: '#81958C', fontSize: 12, fontWeight: '800', marginBottom: 10 },
  card: { flexDirection: 'row', alignItems: 'center', borderWidth: 1, borderColor: '#19392E', borderRadius: 0, backgroundColor: '#0C1C17', padding: 12, marginBottom: 10 }, avatar: { width: 54, height: 54, alignItems: 'center', justifyContent: 'center', borderRadius: 0, overflow: 'hidden', backgroundColor: '#174B3B' }, avatarImage: { width: '100%', height: '100%' }, avatarText: { color: '#62E6B1', fontSize: 21, fontWeight: '900' }, memberInfo: { flex: 1, marginHorizontal: 11 }, name: { color: '#F3FFF9', fontSize: 15, fontWeight: '900' }, handle: { color: '#62E6B1', fontSize: 10, marginTop: 3 }, bio: { color: '#8FA69B', fontSize: 11, lineHeight: 15, marginTop: 5 }, followButton: { backgroundColor: '#62E6B1', borderRadius: 0, paddingHorizontal: 13, paddingVertical: 10 }, followingButton: { backgroundColor: '#173D31' }, followText: { color: '#071310', fontSize: 11, fontWeight: '900' }, followingText: { color: '#62E6B1' },
