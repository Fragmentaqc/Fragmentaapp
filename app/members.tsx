...
export default function MembersScreen() {
  ...
  return <SafeAreaView style={styles.safeArea}>
    <FlatList
      ...
      refreshControl={<RefreshControl refreshing={refreshing} tintColor="#B86F4B" onRefresh={() => { setRefreshing(true); void load(0, true); }} />}
      ...
      ListEmptyComponent={loading ? <ActivityIndicator style={styles.loader} color="#B86F4B" /> : <View style={styles.empty}><Text style={styles.emptyTitle}>Aucun membre trouvé</Text><Text style={styles.emptyText}>Essaie un autre nom, pays ou type d’aventure.</Text></View>}
      ListFooterComponent={loadingMore ? <ActivityIndicator style={styles.footerLoader} color="#B86F4B" /> : <View style={styles.footerSpace} />}
    />
  </SafeAreaView>;
}

const styles = StyleSheet.create({
  safeArea: { flex: 1, backgroundColor: '#0B1710' }, container: { padding: 18, paddingBottom: 70 },
  header: { marginBottom: 18 }, back: { color: '#B86F4B', fontWeight: '800', paddingVertical: 8 }, eyebrow: { color: '#B86F4B', fontSize: 10, fontWeight: '900', letterSpacing: 1.6, marginTop: 12 }, title: { color: '#F4E9D6', fontSize: 30, fontWeight: '900', marginTop: 7 }, subtitle: { color: '#CBD5C8', lineHeight: 20, marginTop: 8 },
  searchBox: { height: 56, flexDirection: 'row', alignItems: 'center', borderWidth: 1, borderColor: '#6F8D6C', borderRadius: 0, backgroundColor: '#173523', paddingHorizontal: 14 }, searchIcon: { color: '#B86F4B', fontSize: 26, marginRight: 9 }, input: { flex: 1, color: '#F4E9D6', fontSize: 15 }, countryInput: { height: 48, color: '#F4E9D6', borderWidth: 1, borderColor: '#35563E', borderRadius: 0, backgroundColor: '#173523', paddingHorizontal: 15, marginTop: 10 },
  chips: { gap: 8, paddingVertical: 14 }, chip: { borderWidth: 1, borderColor: '#3D6648', borderRadius: 0, paddingHorizontal: 14, paddingVertical: 9 }, chipActive: { backgroundColor: '#B86F4B', borderColor: '#B86F4B' }, chipText: { color: '#A7B3A3', fontSize: 12, fontWeight: '800' }, chipTextActive: { color: '#0B1710' }, resultLabel: { color: '#BCC8B8', fontSize: 12, fontWeight: '800', marginBottom: 10 },
  card: { flexDirection: 'row', alignItems: 'center', borderWidth: 1, borderColor: '#35563E', borderRadius: 0, backgroundColor: '#173523', padding: 12, marginBottom: 10 }, avatar: { width: 54, height: 54, alignItems: 'center', justifyContent: 'center', borderRadius: 0, overflow: 'hidden', backgroundColor: '#264C32' }, avatarImage: { width: '100%', height: '100%' }, avatarText: { color: '#B86F4B', fontSize: 21, fontWeight: '900' }, memberInfo: { flex: 1, marginHorizontal: 11 }, name: { color: '#F4E9D6', fontSize: 15, fontWeight: '900' }, handle: { color: '#B86F4B', fontSize: 10, marginTop: 3 }, bio: { color: '#CBD5C8', fontSize: 11, lineHeight: 15, marginTop: 5 }, followButton: { backgroundColor: '#B86F4B', borderRadius: 0, paddingHorizontal: 13, paddingVertical: 10 }, followingButton: { backgroundColor: '#2D5B3D' }, followText: { color: '#0B1710', fontSize: 11, fontWeight: '900' }, followingText: { color: '#B86F4B' },
  loader: { marginTop: 45 }, empty: { alignItems: 'center', padding: 35 }, emptyTitle: { color: '#F4E9D6', fontSize: 18, fontWeight: '900' }, emptyText: { color: '#BCC8B8', textAlign: 'center', marginTop: 8 }, footerLoader: { margin: 20 }, footerSpace: { height: 25 },
});
