...
export default function MembersScreen() {
  ...
  return <SafeAreaView style={styles.safeArea}>
    <FlatList
      ...
      refreshControl={<RefreshControl refreshing={refreshing} tintColor="#E9576F" onRefresh={() => { setRefreshing(true); void load(0, true); }} />}
      ...
      ListEmptyComponent={loading ? <ActivityIndicator style={styles.loader} color="#E9576F" /> : <View style={styles.empty}><Text style={styles.emptyTitle}>Aucun membre trouvé</Text><Text style={styles.emptyText}>Essaie un autre nom, pays ou type d’aventure.</Text></View>}
      ListFooterComponent={loadingMore ? <ActivityIndicator style={styles.footerLoader} color="#E9576F" /> : <View style={styles.footerSpace} />}
    />
  </SafeAreaView>;
}

const styles = StyleSheet.create({
  safeArea: { flex: 1, backgroundColor: '#173E28' }, container: { padding: 18, paddingBottom: 70 },
  header: { marginBottom: 18 }, back: { color: '#E9576F', fontWeight: '800', paddingVertical: 8 }, eyebrow: { color: '#E9576F', fontSize: 10, fontWeight: '900', letterSpacing: 1.6, marginTop: 12 }, title: { color: '#F5E6C8', fontSize: 30, fontWeight: '900', marginTop: 7 }, subtitle: { color: '#D8CFBA', lineHeight: 20, marginTop: 8 },
  searchBox: { height: 56, flexDirection: 'row', alignItems: 'center', borderWidth: 1, borderColor: '#6D9F6B', borderRadius: 0, backgroundColor: '#245A35', paddingHorizontal: 14 }, searchIcon: { color: '#E9576F', fontSize: 26, marginRight: 9 }, input: { flex: 1, color: '#F5E6C8', fontSize: 15 }, countryInput: { height: 48, color: '#F5E6C8', borderWidth: 1, borderColor: '#315F3C', borderRadius: 0, backgroundColor: '#245A35', paddingHorizontal: 15, marginTop: 10 },
  chips: { gap: 8, paddingVertical: 14 }, chip: { borderWidth: 1, borderColor: '#356F43', borderRadius: 0, paddingHorizontal: 14, paddingVertical: 9 }, chipActive: { backgroundColor: '#E9576F', borderColor: '#E9576F' }, chipText: { color: '#9EB0A8', fontSize: 12, fontWeight: '800' }, chipTextActive: { color: '#173E28' }, resultLabel: { color: '#D0C4A9', fontSize: 12, fontWeight: '800', marginBottom: 10 },
  card: { flexDirection: 'row', alignItems: 'center', borderWidth: 1, borderColor: '#315F3C', borderRadius: 0, backgroundColor: '#245A35', padding: 12, marginBottom: 10 }, avatar: { width: 54, height: 54, alignItems: 'center', justifyContent: 'center', borderRadius: 0, overflow: 'hidden', backgroundColor: '#174B3B' }, avatarImage: { width: '100%', height: '100%' }, avatarText: { color: '#E9576F', fontSize: 21, fontWeight: '900' }, memberInfo: { flex: 1, marginHorizontal: 11 }, name: { color: '#F5E6C8', fontSize: 15, fontWeight: '900' }, handle: { color: '#E9576F', fontSize: 10, marginTop: 3 }, bio: { color: '#D8CFBA', fontSize: 11, lineHeight: 15, marginTop: 5 }, followButton: { backgroundColor: '#E9576F', borderRadius: 0, paddingHorizontal: 13, paddingVertical: 10 }, followingButton: { backgroundColor: '#3B7C49' }, followText: { color: '#173E28', fontSize: 11, fontWeight: '900' }, followingText: { color: '#E9576F' },
  loader: { marginTop: 45 }, empty: { alignItems: 'center', padding: 35 }, emptyTitle: { color: '#F5E6C8', fontSize: 18, fontWeight: '900' }, emptyText: { color: '#D0C4A9', textAlign: 'center', marginTop: 8 }, footerLoader: { margin: 20 }, footerSpace: { height: 25 },
});
