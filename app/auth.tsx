...
const styles = StyleSheet.create({
  ...
  forgotText: { color: '#C99A2E', fontSize: 12, fontWeight: '800' },
  visitorNote: { color: '#D8B65A', fontSize: 12, lineHeight: 18, marginTop: -16, marginBottom: 16 },
  consentBox: { borderRadius: 0, borderWidth: 1, borderColor: '#275456', backgroundColor: '#10363A', padding: 14, marginTop: 18, gap: 13 },
  consentRow: { flexDirection: 'row', alignItems: 'flex-start', gap: 10 },
  checkbox: { width: 22, height: 22, borderRadius: 0, borderWidth: 1, borderColor: '#6A9692', alignItems: 'center', justifyContent: 'center' },
  checkboxActive: { backgroundColor: '#C99A2E', borderColor: '#C99A2E' },
  checkmark: { color: '#071A1C', fontSize: 13, fontWeight: '900' },
  consentText: { flex: 1, color: '#A4B8AF', fontSize: 12, lineHeight: 18 },
  legalLinks: { flexDirection: 'row', gap: 18, marginLeft: 32 },
  legalLink: { color: '#C99A2E', fontSize: 11, fontWeight: '900', textDecorationLine: 'underline' },
});
