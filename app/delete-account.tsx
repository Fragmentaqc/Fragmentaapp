...
const styles = StyleSheet.create({ safe: { flex: 1, backgroundColor: '#071310' }, flex: { flex: 1 }, container: { padding: 20, paddingBottom: 70 }, center: { flex: 1, alignItems: 'center', justifyContent: 'center' }, back: { color: '#62E6B1', fontSize: 15, fontWeight: '800', marginBottom: 24 }, eyebrow: { color: '#FF8C8C', fontSize: 10, fontWeight: '900', letterSpacing: 1.2 }, title: { color: '#F3FFF9', fontSize: 28, fontWeight: '900', marginTop: 6 }, warning: { borderRadius: 0, borderWidth: 1, borderColor: '#7B3535', backgroundColor: '#261414', padding: 17, marginTop: 22 }, warningTitle: { color: '#FFB8B8', fontSize: 15, fontWeight: '900' }, warningText: { color: '#D29A9A', fontSize: 12, lineHeight: 19, marginTop: 7 }, label: { color: '#DFFFF2', fontSize: 13, fontWeight: '900', marginTop: 24, marginBottom: 9 }, input: { minHeight: 54, borderRadius: 0, borderWidth: 1, borderColor: '#7B3535', backgroundColor: '#0C1C17', color: '#F3FFF9', padding: 15 }, deleteButton: { minHeight: 58, alignItems: 'center', justifyContent: 'center', borderRadius: 0, backgroundColor: '#B33A3A', marginTop: 22 }, disabled: { opacity: 0.35 }, deleteText: { color: '#FFF', fontSize: 14, fontWeight: '900' } });
