...
export default function BlockedUsersScreen() {
  ...
  return <SafeAreaView style={styles.safe}><ScrollView contentContainerStyle={styles.container}>
    ...
    {loading ? <ActivityIndicator color="#E9576F" style={styles.loader} /> : profiles.length === 0 ? <View style={styles.empty}><Text style={styles.emptyTitle}>Aucun compte bloqué</Text><Text style={styles.emptyText}>Les comptes que tu bloques apparaîtront ici.</Text></View> : profiles.map((profile) => {
...
const styles = StyleSheet.create({ safe: { flex: 1, backgroundColor: '#173E28' }, container: { padding: 20, paddingBottom: 70 }, back: { color: '#E9576F', fontSize: 15, fontWeight: '800', marginBottom: 24 }, eyebrow: { color: '#E9576F', fontSize: 10, fontWeight: '900', letterSpacing: 1.2 }, title: { color: '#F5E6C8', fontSize: 28, fontWeight: '900', marginTop: 6 }, description: { color: '#D8CFBA', fontSize: 13, lineHeight: 20, marginTop: 10 }, loader: { marginTop: 40 }, empty: { borderRadius: 0, backgroundColor: '#245A35', padding: 22, marginTop: 24 }, emptyTitle: { color: '#FFF1D6', fontSize: 15, fontWeight: '900' }, emptyText: { color: '#D0C4A9', fontSize: 12, marginTop: 6 }, row: { flexDirection: 'row', alignItems: 'center', borderRadius: 0, borderWidth: 1, borderColor: '#315F3C', backgroundColor: '#245A35', padding: 11, marginTop: 10 }, avatar: { width: 46, height: 46, borderRadius: 0, alignItems: 'center', justifyContent: 'center', backgroundColor: '#174B3B' }, initial: { color: '#F5E6C8', fontSize: 18, fontWeight: '900' }, identity: { flex: 1, marginLeft: 11 }, name: { color: '#F5E6C8', fontSize: 14, fontWeight: '900' }, handle: { color: '#D0C4A9', fontSize: 11, marginTop: 3 }, unblock: { borderRadius: 0, borderWidth: 1, borderColor: '#6D9F6B', paddingHorizontal: 11, paddingVertical: 8 }, unblockText: { color: '#E9576F', fontSize: 11, fontWeight: '900' } });
