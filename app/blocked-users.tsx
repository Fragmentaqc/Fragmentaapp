...
const styles = StyleSheet.create({ safe: { flex: 1, backgroundColor: '#071310' }, container: { padding: 20, paddingBottom: 70 }, back: { color: '#62E6B1', fontSize: 15, fontWeight: '800', marginBottom: 24 }, eyebrow: { color: '#62E6B1', fontSize: 10, fontWeight: '900', letterSpacing: 1.2 }, title: { color: '#F3FFF9', fontSize: 28, fontWeight: '900', marginTop: 6 }, description: { color: '#8FA69B', fontSize: 13, lineHeight: 20, marginTop: 10 }, loader: { marginTop: 40 }, empty: { borderRadius: 18, backgroundColor: '#0C1C17', padding: 22, marginTop: 24 }, emptyTitle: { color: '#DFFFF2', fontSize: 15, fontWeight: '900' }, emptyText: { color: '#81958C', fontSize: 12, marginTop: 6 }, row: { flexDirection: 'row', alignItems: 'center', borderRadius: 17, borderWidth: 1, borderColor: '#19392E', backgroundColor: '#0C1C17', padding: 11, marginTop: 10 }, avatar: { width: 46, height: 46, borderRadius: 23, alignItems: 'center', justifyContent: 'center', backgroundColor: '#174B3B' }, initial: { color: '#F3FFF9', fontSize: 18, fontWeight: '900' }, identity: { flex: 1, marginLeft: 11 }, name: { color: '#F3FFF9', fontSize: 14, fontWeight: '900' }, handle: { color: '#81958C', fontSize: 11, marginTop: 3 }, unblock: { borderRadius: 12, borderWidth: 1, borderColor: '#28634F', paddingHorizontal: 11, paddingVertical: 8 }, unblockText: { color: '#62E6B1', fontSize: 11, fontWeight: '900' } });
