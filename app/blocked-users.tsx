...
export default function BlockedUsersScreen() {
  ...
  return <SafeAreaView style={styles.safe}><ScrollView contentContainerStyle={styles.container}>
    ...
    {loading ? <ActivityIndicator color="#C99A2E" style={styles.loader} /> : profiles.length === 0 ? <View style={styles.empty}><Text style={styles.emptyTitle}>Aucun compte bloqué</Text><Text style={styles.emptyText}>Les comptes que tu bloques apparaîtront ici.</Text></View> : profiles.map((profile) => {
...
const styles = StyleSheet.create({ safe: { flex: 1, backgroundColor: '#071A1C' }, container: { padding: 20, paddingBottom: 70 }, back: { color: '#C99A2E', fontSize: 15, fontWeight: '800', marginBottom: 24 }, eyebrow: { color: '#C99A2E', fontSize: 10, fontWeight: '900', letterSpacing: 1.2 }, title: { color: '#F4EBD8', fontSize: 28, fontWeight: '900', marginTop: 6 }, description: { color: '#C9D6D1', fontSize: 13, lineHeight: 20, marginTop: 10 }, loader: { marginTop: 40 }, empty: { borderRadius: 0, backgroundColor: '#10363A', padding: 22, marginTop: 24 }, emptyTitle: { color: '#FFF6E5', fontSize: 15, fontWeight: '900' }, emptyText: { color: '#B8C8C2', fontSize: 12, marginTop: 6 }, row: { flexDirection: 'row', alignItems: 'center', borderRadius: 0, borderWidth: 1, borderColor: '#275456', backgroundColor: '#10363A', padding: 11, marginTop: 10 }, avatar: { width: 46, height: 46, borderRadius: 0, alignItems: 'center', justifyContent: 'center', backgroundColor: '#174B3B' }, initial: { color: '#F4EBD8', fontSize: 18, fontWeight: '900' }, identity: { flex: 1, marginLeft: 11 }, name: { color: '#F4EBD8', fontSize: 14, fontWeight: '900' }, handle: { color: '#B8C8C2', fontSize: 11, marginTop: 3 }, unblock: { borderRadius: 0, borderWidth: 1, borderColor: '#4B8180', paddingHorizontal: 11, paddingVertical: 8 }, unblockText: { color: '#C99A2E', fontSize: 11, fontWeight: '900' } });
