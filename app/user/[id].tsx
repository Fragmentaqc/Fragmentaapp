...
export default function PublicProfileScreen() {
  ...
  if (loading) {
    return <SafeAreaView style={styles.safeArea}><View style={styles.center}><ActivityIndicator color="#C99A2E" size="large" /></View></SafeAreaView>;
  }
...
const styles = StyleSheet.create({
  safeArea: { flex: 1, backgroundColor: '#071A1C' }, center: { flex: 1, alignItems: 'center', justifyContent: 'center' },
  hiddenContainer: { flex: 1, alignItems: 'center', justifyContent: 'center', padding: 28, gap: 16 }, hiddenTitle: { color: '#F4EBD8', fontSize: 24, fontWeight: '900' }, hiddenText: { color: '#C9D6D1', textAlign: 'center' }, unblockButton: { borderRadius: 0, backgroundColor: '#174B3B', paddingHorizontal: 20, paddingVertical: 12 }, unblockText: { color: '#C99A2E', fontWeight: '900' },
  container: { padding: 20, paddingBottom: 80 }, back: { alignSelf: 'flex-start', paddingVertical: 8 }, backText: { color: '#C99A2E', fontSize: 15, fontWeight: '800' },
  publicHero: { height: 270, overflow: 'hidden', borderRadius: 0, borderWidth: 1, borderColor: '#3C7475', backgroundColor: '#12382D', marginTop: 10 }, publicCover: { ...StyleSheet.absoluteFillObject, width: '100%', height: '100%' }, publicCoverFallback: { ...StyleSheet.absoluteFillObject, alignItems: 'flex-end', justifyContent: 'center' }, coverLetter: { color: 'rgba(98,230,177,0.08)', fontSize: 210, fontWeight: '900', marginRight: -10 }, publicShade: { ...StyleSheet.absoluteFillObject, backgroundColor: 'rgba(3,12,9,0.48)' }, passportLabel: { position: 'absolute', top: 18, left: 18, color: '#E4C778', fontSize: 9, fontWeight: '900', letterSpacing: 1.6 },
  avatar: { position: 'absolute', left: 18, bottom: 18, width: 94, height: 94, alignItems: 'center', justifyContent: 'center', borderRadius: 0, overflow: 'hidden', backgroundColor: '#174B3B', borderWidth: 3, borderColor: '#C99A2E' },
  avatarImage: { width: '100%', height: '100%' }, avatarText: { color: '#F4EBD8', fontSize: 40, fontWeight: '900' },
  name: { color: '#F4EBD8', fontSize: 28, fontWeight: '900', textAlign: 'center', marginTop: 16 }, handle: { color: '#C99A2E', textAlign: 'center', marginTop: 5 }, country: { color: '#C9D6D1', textAlign: 'center', marginTop: 8 }, bio: { color: '#E6E2D5', fontSize: 14, lineHeight: 21, textAlign: 'center', marginTop: 16 },
  socials: { flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'center', gap: 8, marginTop: 20 }, social: { flexDirection: 'row', borderRadius: 0, borderWidth: 1, borderColor: '#4B8180', backgroundColor: '#16484C', paddingHorizontal: 13, paddingVertical: 9 }, socialText: { color: '#FFF6E5', fontSize: 12, fontWeight: '800' }, socialArrow: { color: '#C99A2E', marginLeft: 6 },
  stats: { flexDirection: 'row', justifyContent: 'center', gap: 10, marginTop: 24 }, stat: { color: '#E6E2D5', borderRadius: 0, backgroundColor: '#10363A', padding: 12 },
  followButton: { alignSelf: 'center', borderRadius: 0, backgroundColor: '#C99A2E', paddingHorizontal: 30, paddingVertical: 12, marginTop: 18 }, followingButton: { backgroundColor: '#1D5A5E' }, followButtonText: { color: '#071A1C', fontWeight: '900' }, followingButtonText: { color: '#C99A2E' },
  socialStats: { flexDirection: 'row', justifyContent: 'center', gap: 40, marginTop: 14 }, socialStatValue: { color: '#F4EBD8', fontSize: 20, fontWeight: '900', textAlign: 'center' }, socialStatLabel: { color: '#B8C8C2', fontSize: 11, marginTop: 3 }, aboutCard: { borderRadius: 0, backgroundColor: '#10363A', padding: 18, marginTop: 24 }, aboutText: { color: '#E6E2D5', lineHeight: 21, marginTop: 8 }, aboutMeta: { color: '#C99A2E', fontSize: 12, fontWeight: '800', marginTop: 12 },
  safetyActions: { flexDirection: 'row', justifyContent: 'center', gap: 6, marginTop: 12 }, reportButton: { paddingHorizontal: 14, paddingVertical: 10 }, reportText: { color: '#B8C8C2', fontSize: 11, fontWeight: '800' }, blockText: { color: '#B77A7A', fontSize: 11, fontWeight: '800' },
  sectionTitle: { color: '#F4EBD8', fontSize: 20, fontWeight: '900', marginTop: 28, marginBottom: 10 }, card: { minHeight: 78, flexDirection: 'row', alignItems: 'center', borderRadius: 0, backgroundColor: '#10363A', borderWidth: 1, borderColor: '#275456', padding: 9, marginBottom: 9 }, cardImage: { width: 60, height: 60, borderRadius: 0, backgroundColor: '#1D5A5E' }, cardContent: { flex: 1, paddingHorizontal: 12 }, cardTitle: { color: '#F4EBD8', fontSize: 14, fontWeight: '900' }, cardSubtitle: { color: '#B8C8C2', fontSize: 11, marginTop: 5 }, arrow: { color: '#C99A2E', fontSize: 27, paddingRight: 5 },
});
