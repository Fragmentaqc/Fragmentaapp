...
const styles = StyleSheet.create({
  ...
  card: { borderRadius: 0, borderWidth: 1, borderColor: '#285345', backgroundColor: '#0C1C17', padding: 16, marginTop: 12 }, cardTop: { flexDirection: 'row', justifyContent: 'space-between', gap: 10 }, reason: { flex: 1, color: '#F3FFF9', fontSize: 15, fontWeight: '900' }, status: { color: '#071310', backgroundColor: '#E9B949', borderRadius: 0, paddingHorizontal: 8, paddingVertical: 5, fontSize: 8, fontWeight: '900' }, date: { color: '#63766D', fontSize: 10, marginTop: 7 }, details: { color: '#B7C9C1', fontSize: 13, lineHeight: 20, marginTop: 12 }, noDetails: { color: '#63766D', fontSize: 11, fontStyle: 'italic', marginTop: 12 }, target: { borderRadius: 0, backgroundColor: '#173D31', padding: 12, marginTop: 13 }, targetText: { color: '#62E6B1', fontSize: 11, fontWeight: '900' }, noteInput: { minHeight: 46, borderRadius: 0, borderWidth: 1, borderColor: '#285345', color: '#F3FFF9', padding: 12, marginTop: 10 }, actions: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginTop: 12 }, review: { borderRadius: 0, backgroundColor: '#28634F', padding: 10 }, reviewText: { color: '#FFF', fontSize: 10, fontWeight: '900' }, resolve: { borderRadius: 0, backgroundColor: '#62E6B1', padding: 10 }, resolveText: { color: '#071310', fontSize: 10, fontWeight: '900' }, dismiss: { borderRadius: 0, borderWidth: 1, borderColor: '#7B3535', padding: 10 }, dismissText: { color: '#FFB8B8', fontSize: 10, fontWeight: '900' }, historyTitle: { color: '#F3FFF9', fontSize: 20, fontWeight: '900', marginTop: 30 }, logCard: { borderLeftWidth: 2, borderLeftColor: '#62E6B1', paddingLeft: 13, paddingVertical: 8, marginTop: 8 }, logChange: { color: '#DFFFF2', fontSize: 12, fontWeight: '900' }, logNote: { color: '#81958C', fontSize: 11, lineHeight: 17, marginTop: 5 }, primary: { minHeight: 50, justifyContent: 'center', borderRadius: 0, backgroundColor: '#62E6B1', paddingHorizontal: 20, marginTop: 20 }, primaryText: { color: '#071310', fontWeight: '900' },
});
