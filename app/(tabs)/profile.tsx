...
const styles = StyleSheet.create({
  ...
  profileMapFilter: { flex: 1, minHeight: 38, alignItems: 'center', justifyContent: 'center', backgroundColor: '#173523', paddingHorizontal: 6 },
  ...
  bilanMetric: { width: '48%', minHeight: 112, backgroundColor: '#102218', padding: 14 },
  ...
  moderationButton: { minHeight: 56, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: '#C58A62', backgroundColor: '#211D0E', marginHorizontal: 22, marginTop: 30 },
