...
const styles = StyleSheet.create({
  ...
  hero: { height: 540, overflow: 'hidden', borderRadius: 0, backgroundColor: '#16484C' },
  ...
  heroEyebrow: { color: '#E4C778', fontSize: 9, fontWeight: '900', letterSpacing: 1.3 },
  ...
  primaryAction: { minHeight: 48, flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', borderRadius: 0, backgroundColor: '#C99A2E', paddingHorizontal: 14 },
  ...
  metrics: { flexDirection: 'row', alignItems: 'center', marginHorizontal: 18, marginTop: 12, borderRadius: 0, backgroundColor: '#10363A', paddingVertical: 14 },
  metric: { flex: 1, alignItems: 'center' },
  metricValue: { color: '#F4EBD8', fontSize: 20, fontWeight: '900' },
  metricLabel: { color: '#A9BBB5', fontSize: 9, fontWeight: '800', textTransform: 'uppercase', marginTop: 3 },
  metricDivider: { width: 1, height: 30, backgroundColor: '#265F63' },
  ...
  sectionTitle: { color: '#F4EBD8', fontSize: 21, fontWeight: '900' },
  ...
  featuredCard: { height: 430, overflow: 'hidden', marginHorizontal: 18, borderRadius: 0, backgroundColor: '#1D5A5E' },
  ...
  categoryCard: { width: 140, minHeight: 130, borderRadius: 0, borderWidth: 1, borderColor: '#265F63', backgroundColor: '#10363A', padding: 15 },
  categoryIcon: { fontSize: 27 },
  categoryName: { color: '#F4EBD8', fontSize: 14, fontWeight: '900', marginTop: 12 },
  categoryCount: { color: '#A9BBB5', fontSize: 10, marginTop: 4 },
  adventureTile: { width: 245, overflow: 'hidden', borderRadius: 0, borderWidth: 1, borderColor: '#265F63', backgroundColor: '#10363A' },
  tileImage: { width: '100%', height: 165 },
  tileFallback: { height: 165, alignItems: 'center', justifyContent: 'center', backgroundColor: '#1D5A5E' },
  tileEmoji: { fontSize: 55 },
  tileContent: { padding: 14 },
  tileCategory: { color: '#C99A2E', fontSize: 8, fontWeight: '900', letterSpacing: .8 },
  tileTitle: { color: '#F4EBD8', fontSize: 16, lineHeight: 21, fontWeight: '900', marginTop: 6 },
  tileLocation: { color: '#B8C8C2', fontSize: 10, marginTop: 8 },
  ...
  curiosityTitle: { color: '#F4EBD8', fontSize: 16, lineHeight: 21, fontWeight: '900', marginTop: 7 },
  curiosityLocation: { color: '#B8C8C2', fontSize: 10, marginTop: 8 },
  recentList: { marginHorizontal: 18, borderTopWidth: 1, borderTopColor: '#275456' },
  recentCard: { minHeight: 96, flexDirection: 'row', alignItems: 'center', borderBottomWidth: 1, borderBottomColor: '#275456', paddingVertical: 15 },
  recentIndex: { width: 42, color: '#6A9692', fontSize: 18, fontWeight: '900' },
  ...
  emptyState: { alignItems: 'center', margin: 18, borderRadius: 0, borderWidth: 1, borderColor: '#3C7475', padding: 26 },
  ...
  contributionCard: { marginHorizontal: 18, marginTop: 34, borderRadius: 0, backgroundColor: '#C99A2E', padding: 22 },
  contributionEyebrow: { color: '#174B3B', fontSize: 9, fontWeight: '900', letterSpacing: 1.2 },
  contributionTitle: { color: '#071A1C', fontSize: 24, lineHeight: 29, fontWeight: '900', marginTop: 8 },
  contributionText: { color: '#174B3B', fontSize: 12, lineHeight: 18, marginTop: 8 },
  contributionActions: { gap: 8, marginTop: 18 },
  contributionPrimary: { minHeight: 48, alignItems: 'center', justifyContent: 'center', borderRadius: 0, backgroundColor: '#071A1C' },
  contributionPrimaryText: { color: '#F4EBD8', fontSize: 12, fontWeight: '900' },
  ...
  contributionSecondaryText: { color: '#071A1C', fontSize: 12, fontWeight: '900' },
});
