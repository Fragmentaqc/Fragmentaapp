      ...
      <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
        ...
        {loading ? (
          <View style={styles.loadingCard}>
            <ActivityIndicator color="#E9576F" />
...
const styles = StyleSheet.create({
  ...
  hero: { height: 540, overflow: 'hidden', borderRadius: 0, backgroundColor: '#2F6F3E' },
  ...
  heroEyebrow: { color: '#F3D7AF', fontSize: 9, fontWeight: '900', letterSpacing: 1.3 },
  ...
  primaryAction: { minHeight: 48, flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', borderRadius: 0, backgroundColor: '#E9576F', paddingHorizontal: 14 },
  primaryActionText: { color: '#173E28', fontSize: 12, fontWeight: '900' },
  primaryActionArrow: { color: '#173E28', fontSize: 17, fontWeight: '900', marginLeft: 7 },
  ...
  metrics: { flexDirection: 'row', alignItems: 'center', marginHorizontal: 18, marginTop: 12, borderRadius: 0, backgroundColor: '#245A35', paddingVertical: 14 },
  metric: { flex: 1, alignItems: 'center' },
  metricValue: { color: '#F5E6C8', fontSize: 20, fontWeight: '900' },
  metricLabel: { color: '#BDB7A3', fontSize: 9, fontWeight: '800', textTransform: 'uppercase', marginTop: 3 },
  metricDivider: { width: 1, height: 30, backgroundColor: '#356F43' },
  loadingCard: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginHorizontal: 18, marginTop: 24, padding: 24 },
  loadingText: { color: '#D0C4A9', fontSize: 12, marginLeft: 10 },
  ...
  sectionTitle: { color: '#F5E6C8', fontSize: 21, fontWeight: '900' },
  sectionSubtitle: { color: '#BDB7A3', fontSize: 11, lineHeight: 16, marginTop: 4 },
  sectionAction: { color: '#E9576F', fontSize: 11, fontWeight: '900' },
  horizontalContent: { gap: 11, paddingHorizontal: 18 },
  featuredCard: { height: 430, overflow: 'hidden', marginHorizontal: 18, borderRadius: 0, backgroundColor: '#3B7C49' },
  ...
  liveBadge: { color: '#173E28', backgroundColor: '#E9576F', borderRadius: 0, overflow: 'hidden', paddingHorizontal: 10, paddingVertical: 6, fontSize: 8, fontWeight: '900' },
  featuredCategory: { color: '#F5E6C8', backgroundColor: 'rgba(7,19,16,.8)', borderRadius: 0, overflow: 'hidden', paddingHorizontal: 10, paddingVertical: 6, fontSize: 9, fontWeight: '900' },
  featuredContent: { position: 'absolute', left: 18, right: 18, bottom: 18 },
  featuredLocation: { color: '#E9576F', fontSize: 11, fontWeight: '900' },
  ...
  featuredOpen: { color: '#E9576F', fontSize: 11, fontWeight: '900' },
  categoryCard: { width: 140, minHeight: 130, borderRadius: 0, borderWidth: 1, borderColor: '#356F43', backgroundColor: '#245A35', padding: 15 },
  categoryIcon: { fontSize: 27 },
  categoryName: { color: '#F5E6C8', fontSize: 14, fontWeight: '900', marginTop: 12 },
  categoryCount: { color: '#BDB7A3', fontSize: 10, marginTop: 4 },
  adventureTile: { width: 245, overflow: 'hidden', borderRadius: 0, borderWidth: 1, borderColor: '#356F43', backgroundColor: '#245A35' },
  tileImage: { width: '100%', height: 165 },
  tileFallback: { height: 165, alignItems: 'center', justifyContent: 'center', backgroundColor: '#3B7C49' },
  tileEmoji: { fontSize: 55 },
  tileContent: { padding: 14 },
  tileCategory: { color: '#E9576F', fontSize: 8, fontWeight: '900', letterSpacing: .8 },
  tileTitle: { color: '#F5E6C8', fontSize: 16, lineHeight: 21, fontWeight: '900', marginTop: 6 },
  tileLocation: { color: '#D0C4A9', fontSize: 10, marginTop: 8 },
  ...
  curiosityFallbackIcon: { color: '#F0A36B', fontSize: 54 },
  curiosityContent: { padding: 14 },
  curiosityMeta: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  curiosityCategory: { flex: 1, color: '#F0A36B', fontSize: 8, fontWeight: '900', textTransform: 'uppercase' },
  verifiedBadge: { color: '#173E28', backgroundColor: '#F0A36B', borderRadius: 0, overflow: 'hidden', paddingHorizontal: 6, paddingVertical: 3, fontSize: 7, fontWeight: '900' },
  curiosityTitle: { color: '#F5E6C8', fontSize: 16, lineHeight: 21, fontWeight: '900', marginTop: 7 },
  curiosityLocation: { color: '#D0C4A9', fontSize: 10, marginTop: 8 },
  recentList: { marginHorizontal: 18, borderTopWidth: 1, borderTopColor: '#315F3C' },
  recentCard: { minHeight: 96, flexDirection: 'row', alignItems: 'center', borderBottomWidth: 1, borderBottomColor: '#315F3C', paddingVertical: 15 },
  recentIndex: { width: 42, color: '#7BA578', fontSize: 18, fontWeight: '900' },
  recentContent: { flex: 1 },
  recentMeta: { color: '#E9576F', fontSize: 8, fontWeight: '900', letterSpacing: .7 },
  recentTitle: { color: '#F5E6C8', fontSize: 15, fontWeight: '900', marginTop: 5 },
  recentAuthor: { color: '#BDB7A3', fontSize: 10, marginTop: 5 },
  recentArrow: { color: '#E9576F', fontSize: 28, marginLeft: 10 },
  emptyState: { alignItems: 'center', margin: 18, borderRadius: 0, borderWidth: 1, borderColor: '#5B8F5D', padding: 26 },
  emptyIcon: { fontSize: 46 },
  emptyTitle: { color: '#F5E6C8', fontSize: 20, fontWeight: '900', marginTop: 12 },
  emptyText: { color: '#D0C4A9', fontSize: 12, lineHeight: 18, textAlign: 'center', marginTop: 7, marginBottom: 18 },
  contributionCard: { marginHorizontal: 18, marginTop: 34, borderRadius: 0, backgroundColor: '#E9576F', padding: 22 },
  contributionEyebrow: { color: '#174B3B', fontSize: 9, fontWeight: '900', letterSpacing: 1.2 },
  contributionTitle: { color: '#173E28', fontSize: 24, lineHeight: 29, fontWeight: '900', marginTop: 8 },
  contributionText: { color: '#174B3B', fontSize: 12, lineHeight: 18, marginTop: 8 },
  contributionActions: { gap: 8, marginTop: 18 },
  contributionPrimary: { minHeight: 48, alignItems: 'center', justifyContent: 'center', borderRadius: 0, backgroundColor: '#173E28' },
  contributionPrimaryText: { color: '#F5E6C8', fontSize: 12, fontWeight: '900' },
  ...
  contributionSecondaryText: { color: '#173E28', fontSize: 12, fontWeight: '900' },
});
