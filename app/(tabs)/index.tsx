...
const styles = StyleSheet.create({
  ...
  profileButton: { width: 44, height: 44, alignItems: 'center', justifyContent: 'center', borderRadius: 5, borderWidth: 1, borderColor: '#285345', backgroundColor: '#10251E' },
  profileButtonText: { color: '#62E6B1', fontSize: 24, fontWeight: '900' },
  hero: { marginHorizontal: 18, borderRadius: 7, borderWidth: 1, borderColor: '#285345', backgroundColor: '#10251E', padding: 22 },
  ...
  primaryAction: { minHeight: 48, flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', borderRadius: 5, backgroundColor: '#62E6B1', paddingHorizontal: 14 },
  ...
  secondaryAction: { minHeight: 48, alignItems: 'center', justifyContent: 'center', borderRadius: 5, borderWidth: 1, borderColor: '#386B59', paddingHorizontal: 15 },
  secondaryActionText: { color: '#DFFFF2', fontSize: 12, fontWeight: '900' },
  metrics: { flexDirection: 'row', alignItems: 'center', marginHorizontal: 18, marginTop: 12, borderRadius: 6, backgroundColor: '#0C1C17', paddingVertical: 14 },
  ...
  featuredCard: { height: 430, overflow: 'hidden', marginHorizontal: 18, borderRadius: 7, backgroundColor: '#173D31' },
  ...
  liveBadge: { color: '#071310', backgroundColor: '#62E6B1', borderRadius: 4, overflow: 'hidden', paddingHorizontal: 10, paddingVertical: 6, fontSize: 8, fontWeight: '900' },
  featuredCategory: { color: '#F3FFF9', backgroundColor: 'rgba(7,19,16,.8)', borderRadius: 4, overflow: 'hidden', paddingHorizontal: 10, paddingVertical: 6, fontSize: 9, fontWeight: '900' },
  ...
  categoryCard: { width: 140, minHeight: 130, borderRadius: 6, borderWidth: 1, borderColor: '#1D4538', backgroundColor: '#0C1C17', padding: 15 },
  ...
  adventureTile: { width: 245, overflow: 'hidden', borderRadius: 6, borderWidth: 1, borderColor: '#1D4538', backgroundColor: '#0C1C17' },
  ...
  curiosityTile: { width: 235, overflow: 'hidden', borderRadius: 6, borderWidth: 1, borderColor: '#3D3920', backgroundColor: '#141A15' },
  ...
  verifiedBadge: { color: '#071310', backgroundColor: '#F6C85F', borderRadius: 3, overflow: 'hidden', paddingHorizontal: 6, paddingVertical: 3, fontSize: 7, fontWeight: '900' },
  ...
  emptyState: { alignItems: 'center', margin: 18, borderRadius: 7, borderWidth: 1, borderColor: '#285345', padding: 26 },
  ...
  contributionCard: { marginHorizontal: 18, marginTop: 34, borderRadius: 7, backgroundColor: '#62E6B1', padding: 22 },
  ...
  contributionPrimary: { minHeight: 48, alignItems: 'center', justifyContent: 'center', borderRadius: 5, backgroundColor: '#071310' },
  contributionPrimaryText: { color: '#F3FFF9', fontSize: 12, fontWeight: '900' },
  contributionSecondary: { minHeight: 46, alignItems: 'center', justifyContent: 'center', borderRadius: 5, borderWidth: 1, borderColor: '#174B3B' },
