...
const styles = StyleSheet.create({
  ...
  favoriteButton: { alignSelf: 'flex-start', borderRadius: 5, borderWidth: 1, borderColor: '#386B59', paddingHorizontal: 14, paddingVertical: 10, marginTop: 14 },
  ...
  addFragmentButton: { borderRadius: 5, backgroundColor: '#62E6B1', paddingHorizontal: 13, paddingVertical: 10 },
  addFragmentButtonText: { color: '#071310', fontSize: 11, fontWeight: '900' },
  fragmentLoader: { marginTop: 24 },
  fragmentCard: { borderRadius: 6, borderWidth: 1, borderColor: '#285345', backgroundColor: '#10251E', padding: 17, marginHorizontal: 18, marginTop: 12 },
  ...
  draftBadge: { color: '#071310', backgroundColor: '#E9B949', fontSize: 8, fontWeight: '900', borderRadius: 4, paddingHorizontal: 8, paddingVertical: 5 },
  ...
  fragmentImage: { width: 245, height: 190, borderRadius: 4 },
  fragmentActions: { flexDirection: 'row', gap: 9, marginTop: 13 },
  fragmentEditButton: { flex: 1, alignItems: 'center', borderRadius: 5, backgroundColor: '#28634F', padding: 11 },
  fragmentEditText: { color: '#F3FFF9', fontSize: 11, fontWeight: '900' },
  fragmentDeleteButton: { flex: 1, alignItems: 'center', borderRadius: 5, borderWidth: 1, borderColor: '#7B3535', padding: 11 },
  fragmentDeleteText: { color: '#FFB8B8', fontSize: 11, fontWeight: '900' },
  emptyFragments: { borderRadius: 6, borderWidth: 1, borderColor: '#19392E', padding: 18, marginHorizontal: 18, marginTop: 12 },
  ...
  statCard: { width: '48%', minHeight: 88, justifyContent: 'center', borderRadius: 6, borderWidth: 1, borderColor: '#19392E', backgroundColor: '#0C1C17', padding: 14 },
  ...
  routeMapCard: { overflow: 'hidden', borderRadius: 6, borderWidth: 1, borderColor: '#285345', backgroundColor: '#10251E', marginHorizontal: 18, marginTop: 16 },
  ...
  directionsButton: { marginLeft: 'auto', borderRadius: 5, backgroundColor: '#62E6B1', paddingHorizontal: 12, paddingVertical: 9 },
  ...
  editButton: { minHeight: 52, alignItems: 'center', justifyContent: 'center', borderRadius: 5, backgroundColor: '#62E6B1' },
  editButtonText: { color: '#071310', fontSize: 14, fontWeight: '900' },
  deleteButton: { minHeight: 52, alignItems: 'center', justifyContent: 'center', borderRadius: 5, borderWidth: 1, borderColor: '#7B3535', backgroundColor: '#261414' },
