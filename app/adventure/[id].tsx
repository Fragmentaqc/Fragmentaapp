  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        ...
        {loadingAdventureId === adventure.id ? <ActivityIndicator color="#C99A2E" style={styles.fragmentLoader} /> : fragments.length ? fragments.map((fragment) => (
  ...
  return (
    <View style={styles.routeMapCard}>
      ...
      <MapView style={styles.routeMap} initialRegion={initialRegion} scrollEnabled zoomEnabled>
        {displayedCoordinates.length > 1 ? <Polyline coordinates={displayedCoordinates} strokeColor="#C99A2E" strokeWidth={5} /> : null}
        {adventureCoordinate ? <Marker coordinate={adventureCoordinate} title={adventure.title} description="Point de l’aventure" pinColor="#D8B65A" /> : null}
        {fragmentCoordinates.map((fragment, index) => (
          <Marker key={fragment.id} coordinate={fragment} title={fragment.title} description={`Fragment ${index + 1}`} pinColor="#C99A2E" />
        ))}
      </MapView>
...
const styles = StyleSheet.create({
  ...
  loadingText: { color: '#B8C8C2', fontSize: 13, marginTop: 12 },
  topBar: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  backIcon: { color: '#C99A2E', fontSize: 34, lineHeight: 36 },
  statusBadge: {
    flexDirection: 'row',
    alignItems: 'center',
    borderRadius: 0,
  ...
  statusDot: { color: '#C99A2E', fontSize: 9, marginRight: 7 },
  statusText: { color: '#FFF6E5', fontSize: 10, fontWeight: '900' },
  gallery: { position: 'relative', minHeight: 310, backgroundColor: '#16484C' },
  ...
  imageCountText: { color: '#FFF6E5', fontSize: 10, fontWeight: '900' },
  ...
  favoriteButton: { alignSelf: 'flex-start', borderRadius: 0, borderWidth: 1, borderColor: '#6A9692', paddingHorizontal: 14, paddingVertical: 10, marginTop: 14 },
  favoriteButtonActive: { backgroundColor: '#C99A2E', borderColor: '#C99A2E' },
  favoriteButtonText: { color: '#FFF6E5', fontSize: 12, fontWeight: '900' },
  favoriteButtonTextActive: { color: '#071A1C' },
  authorCard: {
    flexDirection: 'row',
    alignItems: 'center',
    borderRadius: 0,
  ...
  avatarText: { color: '#C99A2E', fontSize: 18, fontWeight: '900' },
  authorContent: { flex: 1, marginLeft: 12 },
  authorLabel: { color: '#657970', fontSize: 8, fontWeight: '900' },
  authorName: { color: '#F4EBD8', fontSize: 14, fontWeight: '900', marginTop: 3 },
  authorHandle: { color: '#C99A2E', fontSize: 10, marginTop: 2 },
  date: { color: '#A9BBB5', fontSize: 9, maxWidth: 92, textAlign: 'right' },
  routeCard: {
    borderRadius: 0,
    borderWidth: 1,
    borderColor: '#3C7475',
  ...
  routeMarkerText: { color: '#071A1C', fontSize: 12, fontWeight: '900' },
  routeContent: { flex: 1, marginLeft: 12 },
  routeLabel: { color: '#70877D', fontSize: 9, fontWeight: '800' },
  routeValue: { color: '#F4EBD8', fontSize: 14, fontWeight: '800', marginTop: 3 },
  routeLine: { width: 2, height: 18, backgroundColor: '#3C7475', marginLeft: 16 },
  detailsRow: {
    flexDirection: 'row',
    gap: 10,
    marginHorizontal: 18,
  ...
  detailValue: { color: '#FFF6E5', fontSize: 14, fontWeight: '900', marginTop: 5 },
  descriptionCard: {
    borderRadius: 0,
    borderWidth: 1,
    borderColor: '#275456',
  ...
  sectionTitle: { color: '#F4EBD8', fontSize: 19, fontWeight: '900', marginTop: 5 },
  ...
  addFragmentButton: { borderRadius: 0, backgroundColor: '#C99A2E', paddingHorizontal: 13, paddingVertical: 10 },
  addFragmentButtonText: { color: '#071A1C', fontSize: 11, fontWeight: '900' },
  fragmentLoader: { marginTop: 24 },
  fragmentCard: { borderRadius: 0, borderWidth: 1, borderColor: '#3C7475', backgroundColor: '#16484C', padding: 17, marginHorizontal: 18, marginTop: 12 },
  fragmentTopRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  fragmentDate: { color: '#C99A2E', fontSize: 10, fontWeight: '900', textTransform: 'uppercase' },
  draftBadge: { color: '#071A1C', backgroundColor: '#D8B65A', fontSize: 8, fontWeight: '900', borderRadius: 0, paddingHorizontal: 8, paddingVertical: 5 },
  fragmentTitle: { color: '#F4EBD8', fontSize: 18, fontWeight: '900', marginTop: 10 },
  ...
  fragmentEditButton: { flex: 1, alignItems: 'center', borderRadius: 0, backgroundColor: '#4B8180', padding: 11 },
  fragmentEditText: { color: '#F4EBD8', fontSize: 11, fontWeight: '900' },
  ...
  emptyFragments: { borderRadius: 0, borderWidth: 1, borderColor: '#275456', padding: 18, marginHorizontal: 18, marginTop: 12 },
  emptyFragmentsText: { color: '#A9BBB5', fontSize: 12, textAlign: 'center' },
  statsSection: { marginHorizontal: 18, marginTop: 24 },
  statsTitle: { color: '#F4EBD8', fontSize: 19, fontWeight: '900', marginTop: 5, marginBottom: 12 },
  statsGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 10 },
  statCard: { width: '48%', minHeight: 88, justifyContent: 'center', borderRadius: 0, borderWidth: 1, borderColor: '#275456', backgroundColor: '#10363A', padding: 14 },
  statValue: { color: '#C99A2E', fontSize: 20, fontWeight: '900' },
  statLabel: { color: '#B8C8C2', fontSize: 10, fontWeight: '800', marginTop: 5 },
  statsHelper: { color: '#9FB2AD', fontSize: 10, lineHeight: 15, marginTop: 9 },
  routeMapCard: { overflow: 'hidden', borderRadius: 0, borderWidth: 1, borderColor: '#3C7475', backgroundColor: '#16484C', marginHorizontal: 18, marginTop: 16 },
  routeMapHeading: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', padding: 16 },
  routeMapTitle: { color: '#F4EBD8', fontSize: 18, fontWeight: '900', marginTop: 4 },
  routeMapCount: { color: '#82AA99', fontSize: 10, fontWeight: '800' },
  routeMapMeta: { alignItems: 'flex-end' },
  routeMapDistance: { color: '#C99A2E', fontSize: 18, fontWeight: '900' },
  routeMap: { width: '100%', height: 260 },
  routeMapHelper: { color: '#A9BBB5', fontSize: 10, lineHeight: 15, paddingHorizontal: 16, paddingVertical: 12 },
  coordinatesCard: {
    flexDirection: 'row',
    alignItems: 'center',
    borderRadius: 0,
  ...
  coordinatesIcon: { color: '#C99A2E', fontSize: 25, marginRight: 12 },
  coordinatesTitle: { color: '#F4EBD8', fontSize: 12, fontWeight: '900' },
  coordinatesText: { color: '#82AA99', fontSize: 11, marginTop: 4 },
  directionsButton: { marginLeft: 'auto', borderRadius: 0, backgroundColor: '#C99A2E', paddingHorizontal: 12, paddingVertical: 9 },
  directionsButtonText: { color: '#071A1C', fontSize: 11, fontWeight: '900' },
  emptyEmoji: { fontSize: 48 },
  emptyTitle: { color: '#F4EBD8', fontSize: 21, fontWeight: '900', marginTop: 13 },
  emptyText: {
    color: '#B8C8C2',
    fontSize: 13,
    lineHeight: 20,
  ...
  primaryButtonText: { color: '#071A1C', fontSize: 13, fontWeight: '900' },
  ownerActions: { marginHorizontal: 18, marginTop: 22, gap: 10 },
  editButton: { minHeight: 52, alignItems: 'center', justifyContent: 'center', borderRadius: 0, backgroundColor: '#C99A2E' },
  editButtonText: { color: '#071A1C', fontSize: 14, fontWeight: '900' },
  ...
  reportButtonText: { color: '#B8C8C2', fontSize: 11, fontWeight: '800' },
});
