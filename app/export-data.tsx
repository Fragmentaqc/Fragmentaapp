...
export default function ExportDataScreen() {
  ...
  return <SafeAreaView style={styles.safe}><ScrollView contentContainerStyle={styles.container}>
    ...
    <Pressable style={[styles.button, exporting && styles.disabled]} onPress={() => void exportData()} disabled={exporting}>{exporting ? <ActivityIndicator color="#071310" /> : <Text style={styles.buttonText}>Créer mon export JSON</Text>}</Pressable>
  </ScrollView></SafeAreaView>;
}

const styles = StyleSheet.create({ safe: { flex: 1, backgroundColor: '#071310' }, container: { padding: 20, paddingBottom: 70 }, back: { color: '#62E6B1', fontSize: 15, fontWeight: '800', marginBottom: 24 }, eyebrow: { color: '#62E6B1', fontSize: 10, fontWeight: '900', letterSpacing: 1.2 }, title: { color: '#F3FFF9', fontSize: 28, fontWeight: '900', marginTop: 6 }, description: { color: '#8FA69B', fontSize: 13, lineHeight: 20, marginTop: 10 }, card: { borderRadius: 20, borderWidth: 1, borderColor: '#285345', backgroundColor: '#0C1C17', padding: 17, marginTop: 23 }, cardTitle: { color: '#DFFFF2', fontSize: 15, fontWeight: '900', marginBottom: 8 }, item: { color: '#A2B3AB', fontSize: 12, lineHeight: 22 }, notice: { color: '#E9B949', fontSize: 11, lineHeight: 18, marginTop: 18 }, button: { minHeight: 58, alignItems: 'center', justifyContent: 'center', borderRadius: 18, backgroundColor: '#62E6B1', marginTop: 22 }, buttonText: { color: '#071310', fontSize: 14, fontWeight: '900' }, disabled: { opacity: 0.5 } });
