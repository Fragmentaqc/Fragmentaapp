...
const styles = StyleSheet.create({
  ...
  photoButton: { height: 150, alignItems: 'center', justifyContent: 'center', borderRadius: 20, borderWidth: 1, borderStyle: 'dashed', borderColor: '#386B59', backgroundColor: '#0C1C17' },
  ...
  image: { width: 120, height: 140, borderRadius: 16 }, remove: { position: 'absolute', right: 6, top: 6, width: 28, height: 28, borderRadius: 14, backgroundColor: 'rgba(0,0,0,.7)', alignItems: 'center', justifyContent: 'center' }, removeText: { color: '#FFF', fontSize: 20 },
  label: { color: '#DFFFF2', fontSize: 14, fontWeight: '800', marginTop: 18, marginBottom: 8 }, input: { minHeight: 54, borderRadius: 16, borderWidth: 1, borderColor: '#1D4538', backgroundColor: '#0C1C17', color: '#F3FFF9', padding: 15 }, area: { minHeight: 150 },
  publish: { minHeight: 56, alignItems: 'center', justifyContent: 'center', borderRadius: 18, backgroundColor: '#62E6B1', marginTop: 26 }, publishText: { color: '#071310', fontWeight: '900', fontSize: 15 },
