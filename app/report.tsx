...
const styles = StyleSheet.create({
  ...
  reasons: { gap: 8 }, reason: { minHeight: 50, flexDirection: 'row', alignItems: 'center', borderRadius: 0, borderWidth: 1, borderColor: '#1D4538', backgroundColor: '#0C1C17', paddingHorizontal: 14 }, reasonActive: { borderColor: '#62E6B1', backgroundColor: '#173D31' }, dot: { width: 12, height: 12, borderRadius: 0, borderWidth: 2, borderColor: '#71877D', marginRight: 11 }, dotActive: { borderColor: '#62E6B1', backgroundColor: '#62E6B1' }, reasonText: { color: '#DFFFF2', fontSize: 13, fontWeight: '800' },
  area: { minHeight: 140, borderRadius: 0, borderWidth: 1, borderColor: '#1D4538', backgroundColor: '#0C1C17', color: '#F3FFF9', padding: 15 }, count: { color: '#63766D', fontSize: 10, textAlign: 'right', marginTop: 5 }, notice: { borderRadius: 0, backgroundColor: '#10251E', padding: 14, marginTop: 18 }, noticeText: { color: '#81958C', fontSize: 11, lineHeight: 17 }, submit: { minHeight: 56, alignItems: 'center', justifyContent: 'center', borderRadius: 0, backgroundColor: '#E9B949', paddingHorizontal: 22, marginTop: 22 }, submitText: { color: '#071310', fontSize: 14, fontWeight: '900' },
});
