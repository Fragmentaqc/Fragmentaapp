...
const styles = StyleSheet.create({
  ...
  favoriteButton: { alignSelf: 'flex-start', borderRadius: 5, borderWidth: 1, borderColor: '#386B59', paddingHorizontal: 14, paddingVertical: 10, marginTop: 12 },
  ...
  directionsCard: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', borderRadius: 6, backgroundColor: '#173D31', padding: 17, marginTop: 14 },
  ...
  verifyButton: { minHeight: 52, alignItems: 'center', justifyContent: 'center', borderRadius: 5, borderWidth: 1, borderColor: '#E9B949', backgroundColor: '#2A2412' },
  ...
  decisionCard: { borderRadius: 5, borderWidth: 1, borderColor: '#7B3535', backgroundColor: '#261414', padding: 13 },
  decisionTitle: { color: '#FFB8B8', fontSize: 12, fontWeight: '900' },
  decisionText: { color: '#D29A9A', fontSize: 11, lineHeight: 17, marginTop: 5 },
  approvedCard: { borderRadius: 5, backgroundColor: '#173D31', padding: 13 },
