...
const styles = StyleSheet.create({ safe: { flex: 1, backgroundColor: '#071310' }, container: { flex: 1, padding: 22, justifyContent: 'center' }, back: { color: '#62E6B1', fontSize: 15, fontWeight: '800', marginBottom: 30 }, eyebrow: { color: '#62E6B1', fontSize: 10, fontWeight: '900', letterSpacing: 1.2 }, title: { color: '#F3FFF9', fontSize: 29, fontWeight: '900', marginTop: 6 }, description: { color: '#8FA69B', fontSize: 13, lineHeight: 20, marginTop: 10, marginBottom: 20 }, label: { color: '#DFFFF2', fontSize: 13, fontWeight: '900', marginBottom: 8 }, input: { minHeight: 56, borderRadius: 16, borderWidth: 1, borderColor: '#1D4538', backgroundColor: '#0C1C17', color: '#F3FFF9', paddingHorizontal: 16 }, button: { minHeight: 58, alignItems: 'center', justifyContent: 'center', borderRadius: 18, backgroundColor: '#62E6B1', marginTop: 22 }, buttonText: { color: '#071310', fontSize: 14, fontWeight: '900' }, disabled: { opacity: 0.45 } });
