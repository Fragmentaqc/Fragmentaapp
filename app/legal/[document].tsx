...
const styles = StyleSheet.create({ safe: { flex: 1, backgroundColor: '#173E28' }, container: { padding: 20, paddingBottom: 70 }, back: { color: '#E9576F', fontSize: 15, fontWeight: '800', marginBottom: 24 }, eyebrow: { color: '#E9576F', fontSize: 10, fontWeight: '900', letterSpacing: 1.2 }, title: { color: '#F5E6C8', fontSize: 28, lineHeight: 34, fontWeight: '900', marginTop: 6 }, updated: { color: '#D0C4A9', fontSize: 11, marginTop: 8, marginBottom: 12 }, section: { color: '#AFC2B9', fontSize: 13, lineHeight: 21, marginTop: 18 }, heading: { color: '#FFF1D6', fontSize: 16, fontWeight: '900' }, review: { color: '#F0A36B', fontSize: 10, lineHeight: 16, marginTop: 28 } });
