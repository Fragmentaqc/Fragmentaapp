...
const styles = StyleSheet.create({ safe: { flex: 1, backgroundColor: '#071310' }, container: { padding: 20, paddingBottom: 70 }, back: { color: '#62E6B1', fontSize: 15, fontWeight: '800', marginBottom: 24 }, eyebrow: { color: '#62E6B1', fontSize: 10, fontWeight: '900', letterSpacing: 1.2 }, title: { color: '#F3FFF9', fontSize: 28, lineHeight: 34, fontWeight: '900', marginTop: 6 }, updated: { color: '#81958C', fontSize: 11, marginTop: 8, marginBottom: 12 }, section: { color: '#AFC2B9', fontSize: 13, lineHeight: 21, marginTop: 18 }, heading: { color: '#DFFFF2', fontSize: 16, fontWeight: '900' }, review: { color: '#E9B949', fontSize: 10, lineHeight: 16, marginTop: 28 } });
