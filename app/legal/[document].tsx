...
const styles = StyleSheet.create({ safe: { flex: 1, backgroundColor: '#071A1C' }, container: { padding: 20, paddingBottom: 70 }, back: { color: '#C99A2E', fontSize: 15, fontWeight: '800', marginBottom: 24 }, eyebrow: { color: '#C99A2E', fontSize: 10, fontWeight: '900', letterSpacing: 1.2 }, title: { color: '#F4EBD8', fontSize: 28, lineHeight: 34, fontWeight: '900', marginTop: 6 }, updated: { color: '#B8C8C2', fontSize: 11, marginTop: 8, marginBottom: 12 }, section: { color: '#AFC2B9', fontSize: 13, lineHeight: 21, marginTop: 18 }, heading: { color: '#FFF6E5', fontSize: 16, fontWeight: '900' }, review: { color: '#D8B65A', fontSize: 10, lineHeight: 16, marginTop: 28 } });
